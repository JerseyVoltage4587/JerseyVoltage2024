...
import frc.robot.commands.Intake.backIntake;
...
public class OI extends Command{
    ...
    public OI() {
        ...
        kLeftTrigger.whileTrue(new runShooter());
        kRightTrigger.whileTrue(new runIntake());
        kButtonX.whileTrue(new ArmUp());
        kButtonB.whileTrue(new ArmDown());
        kRightBumper.whileTrue(new backIntake());
    }
